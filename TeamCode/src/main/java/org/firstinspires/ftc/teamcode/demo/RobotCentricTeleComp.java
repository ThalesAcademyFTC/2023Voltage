...
public class RobotCentricTele extends OpMode {
    ...
    public void loop() {
        ...
        double yLeftStick = -gamepad1.left_stick_y; // Y gamepad is reversed, so reverse this value
        double xLeftStick = gamepad1.left_stick_x * STRAFE_FACTOR; // Scaling to fix
